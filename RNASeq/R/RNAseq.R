...
system.time({
    rna_seq_data <- read_tsv("./R/RNAseq/data/GSE116583_transplant.am.htseq.all.rpkm.txt.gz", col_names = TRUE)
    Sys.sleep(5) # Example command that pauses for 2 seconds
})
